...
We provide [a conversion and rendering script](./docs/convert_public_dataset.md) for the Waymo Open Dataset as an example of how information from another AV source can interface with the model. 
